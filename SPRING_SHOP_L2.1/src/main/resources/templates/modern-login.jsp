...
<body>
<br><a href="index">Main page</a><br>
<div>
    <div id="loginbox" style="margin-top: 50px;" class="mainbox col-md-3col-md-offset-2 col-sm-6 col-sm-offset-2">
        <div class="panel panel-info">
            ...
            <div style="padding-top: 30px" class="panel-body">
                            ...
                            <div>
                                <div th:if="${param.error} != null">
                                    <div class="alert alert-dangercol-xs-offset-1 col-xs-10">
                                        Invalid222 username or password
                                    </div>
                                </div>
                ...
                <div style="margin-top: 10px" class="reg-ref-group">
                    <button onclick="window.location.href = 'registration'">New user registration</button>
                </div>
            </div>
        </div>
    </div>
